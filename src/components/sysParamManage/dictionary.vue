	...
	<div class="clearfix">
	 		...
	 		<div>
	 			...
	 			<el-dialog :close-on-click-modal ='false' :title="bigClassTitle" class="dialog-wrap" :visible.sync="dialogFormVisible" width='400px' @close="addDiaClose">
				    <el-form :model="form" ref="form" :rules="form_rules">
					    ...
					    <el-form-item label="大类编码" :label-width="formLabelWidth" required prop="code" >
 		...
 		<div class="addDetail ft">
 			...
 			<div class="detail-wrap"  v-show='orShowDetail'>
 				<div class="m20" style="padding-bottom: 15px;"><el-button type="primary" @click='showDetail'>新增明细</el-button></div>
 				<el-table
				    :data="detailData"
...
//  					price:this.form.price
    				...
    				if (this.flagCode) {//修改时不传pararms.code
    					delete pararms.code
    				}
    				console.log(pararms,'/////////////')
