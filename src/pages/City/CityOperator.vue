          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="性别" prop="region">
              <el-select v-model="ruleForm.region">
                <el-option label="未设置" value="shanghai"></el-option>
            ...
            <el-form-item label="城市ID" prop="name">

            </el-form-item>
            <el-form-item label="小区域ID" prop="name">
              <el-input v-model="ruleForm.name"></el-input>
            </el-form-item>
            <el-form-item label="小区域名称" prop="name">
              <el-input v-model="ruleForm.name"></el-input>
            </el-form-item>
            <el-form-item label="管理员类型" prop="region">
              <el-select v-model="ruleForm.region">
                <el-option label="兼职人员" value="shanghai"></el-option>
                <el-option label="运营督导" value="beijing"></el-option>
                <el-option label="运维人员" value="beijing"></el-option>
                <el-option label="维修人员" value="beijing"></el-option>
                <el-option label="调度人员" value="beijing"></el-option>
              </el-select>
            </el-form-item>
