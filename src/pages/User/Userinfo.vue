...
<label>姓名：</label><input id="inp5"><span></span><br/>
<label>邮箱：</label><input id="inp3"><span></span><br/>
<label>座机：</label><input id="inp4"><span></span><br/>
<label>手机：</label><input id="inp2"><span></span><br/>
